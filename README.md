...
Esse script é a continuação do [arch-install](https://github.com/ffranksz/arch-install), só que esse roda dentro do chroot.
...
Logo após de ter executado com êxito o [script anterior](https://github.com/ffranksz/arch-install), entre dentro do chroot e execute esse, com esses comandos:

``` sh
arch-chroot /mnt
wget -c "https://raw.githubusercontent.com/ffranksz/arch-chroot/main/arch-chroot.sh"
...
Caso não queira remover, pode deixa-lo onde está, não afeta em nada no uso.
